...
# sorted_handles = sort_handles_alphabetically(handles_tweutteur)
...
def sort_handles_by_length(handles)
  sorted_handles = handles.sort_by { |handle| handle.length - handle.count('@') }
  return sorted_handles
end

# Call of the method that sort by lenth
#sorted_handles = sort_handles_by_length(handles_tweutteur)
